...
const Product = ({ product, handleAddtoCart }) => {
      ...
      return (
            ...
            ">
                  ...
                  <button className="btn w-fit mt-4 bg-transparent border-2 border-sky-500 text-sky-500  hover:bg-transparent" onClick={handelCart}> <IoCart className="text-xl" />  Add to cart</button>
            </div>
      );
};
